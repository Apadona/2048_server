...
{
  color_2              = QtCssColorBuilder::Build({ 94, 90, 86 }, { 47, 44, 40 });
  color_4              = QtCssColorBuilder::Build({ 93, 88, 78 }, { 47, 44, 40 });
  color_8              = QtCssColorBuilder::Build({ 95, 70, 48 }, { 98, 70, 95 });
  color_16             = QtCssColorBuilder::Build({ 96, 60, 40 }, { 98, 70, 95 });
  color_32             = QtCssColorBuilder::Build({ 97, 50, 38 }, { 98, 70, 95 });
  color_64             = QtCssColorBuilder::Build({ 97, 37, 23 }, { 98, 70, 95 });
  color_128            = QtCssColorBuilder::Build({ 93, 81, 45 }, { 98, 70, 95 });
  color_256            = QtCssColorBuilder::Build({ 93, 80, 39 }, { 98, 70, 95 });
  color_512            = QtCssColorBuilder::Build({ 93, 79, 32 }, { 98, 70, 95 });
  color_1024           = QtCssColorBuilder::Build({ 93, 78, 25 }, { 98, 70, 95 });
  color_2048           = QtCssColorBuilder::Build({ 93, 76, 18 }, { 98, 70, 95 });
  color_4098_and_upper = QtCssColorBuilder::Build({ 3, 3, 3 }, { 98, 70, 95 });
}
